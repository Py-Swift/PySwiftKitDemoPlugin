...
All notable changes to the "kv-to-pyclass" extension will be documented in this file.

## [0.1.0] - 2025-12-30

### Added
- Initial release of KV to PyClass extension
...
### Configuration
- `kvToPyClass.autoGenerate` - Enable/disable automatic generation
- `kvToPyClass.debounceDelay` - Delay before generating (default: 500ms)
- `kvToPyClass.previewOnSide` - Open preview beside editor
