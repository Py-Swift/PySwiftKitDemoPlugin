...
Generate Python classes from Kivy KV language files automatically.
...
- `kvToPyClass.autoGenerate` - Automatically generate Python classes when files change (default: `true`)
- `kvToPyClass.debounceDelay` - Delay in milliseconds before generating code after changes (default: `500`)
- `kvToPyClass.previewOnSide` - Open preview panel to the side (default: `true`)

## How It Works

The extension uses the KvToPyClass generator compiled to WebAssembly from Swift. When you edit a KV file:
